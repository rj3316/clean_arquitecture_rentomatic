...
def test_room_build_read_request_without_parameters():
    # 
    request = BuilderRoomReadRequest.build_read_request()
...
def test_room_build_read_requests_with_invalid_filters_parameters():
    request = BuilderRoomReadRequest.build_read_request(filters=5)
...
def test_room_build_read_requests_with_incorrect_filter_keys():
    request = BuilderRoomReadRequest.build_read_request(filters={'a':1})
...
def test_room_build_read_request_accepted_filters(key):
    ...
    request = BuilderRoomReadRequest.build_read_request(filters = filters)
